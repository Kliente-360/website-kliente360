...
2. **Human review of automated decisions is a certain destination, not a hypothesis.** Technical Note 12/2025 shows the ANPD moving toward regulating LGPD's Article 20 specifically for AI. Whoever already has an escalation-to-human process — with [someone formally named to own that review](/blog/en/dono-do-agente-cargo-2026.html) — won't have to scramble when the rule lands. Proving that review happened depends on an [audit trail generated automatically by the pipeline](/blog/en/governanca-dados-como-codigo.html), not on reconstructing evidence under pressure when the auditor asks. The question of who approves what gets clearer once the company decides, up front, [whether AI governance and data governance form one program or two](/blog/en/governanca-ia-governanca-dados-um-ou-dois-programas.html) — the ANPD enforces the review's outcome, not the org chart behind it.
