---
title: "A ANPD já fiscaliza IA no Brasil — mesmo com a lei travada no Congresso"
slug: "anpd-fiscalizacao-ia-brasil"
pillar: "ai"
date: "2026-07-21"
readMinutes: 7
excerpt: "PL 2338 segue travado no Congresso, mas a ANPD já elegeu IA eixo de fiscalização 2026–2027 — o que muda pra quem treina modelo com dado real."
tldr: "A ANPD é a autoridade que já fiscaliza uso de IA com dado pessoal no Brasil mesmo sem o marco legal da IA (PL 2338/2023) aprovado — o projeto segue travado no Congresso, sem votação prevista após o recesso de julho de 2026. A agência elegeu IA como um dos quatro eixos da própria Agenda Regulatória pra 2026–2027, já publicou nota técnica sobre revisão humana de decisão automatizada e outra sobre conteúdo sintético como dado pessoal, e virou agência reguladora com mais poder de fiscalizar. Nenhuma multa foi aplicada especificamente por treino de modelo até hoje — mas a estrutura pra aplicá-la já está de pé."
keywords: ["ANPD", "regulação de IA", "PL 2338", "LGPD", "IA generativa", "compliance de IA"]
---
...
1. **Base legal documentada por escrito, já.** Consentimento, execução de contrato ou interesse legítimo — cada categoria de dado usada em treino ou prompt precisa de base legal registrada, exatamente [como já detalhamos na checklist de governança de LLM](/blog/privacidade-dados-llms.html). Isso não depende do PL 2338; é exigência da LGPD vigente.
2. **Revisão humana de decisão automatizada é destino certo, não hipótese.** A Nota Técnica 12/2025 mostra a ANPD caminhando pra regulamentar o art. 20 da LGPD especificamente pra IA. Quem já tem processo de escalonamento pra humano — com [alguém formalmente nomeado pra essa revisão](/blog/dono-do-agente-cargo-2026.html) — não vai precisar correr quando a norma sair. Provar que a revisão aconteceu depende de [trilha de auditoria gerada automaticamente pelo pipeline](/blog/governanca-dados-como-codigo.html), não de reconstruir evidência sob pressão quando o auditor perguntar. A régua de quem aprova o quê fica mais clara quando a empresa decide, de antemão, [se governança de IA e governança de dados formam um programa só ou dois](/blog/governanca-ia-governanca-dados-um-ou-dois-programas.html) — a ANPD fiscaliza o resultado da revisão, não o organograma por trás dele.
3. **Conteúdo gerado por IA que identifica uma pessoa é dado pessoal — sem margem pra dúvida.** É a posição que a ANPD já aplicou no caso do Grok/X. Vale pra deepfake, mas também vale pra qualquer output de agente que produza algo atribuível a um cliente ou candidato real — [como discutimos no risco de triagem de currículo com IA](/blog/ia-para-rh.html), o dado sensível de uma pessoa identificável não perde proteção só porque passou por um modelo.
