...
2. **Escolha de modelo por caso de uso, não global.** Usar GPT-4o ou Claude Sonnet pra classificar intent é desperdício. Pra geração de resposta complexa, vale. Pra summarização curta, modelo médio (Haiku, GPT-4o mini) entrega 90% da qualidade por 10% do preço. Sistema que usa o mesmo modelo pra tudo paga 5–10× mais que sistema com routing. Levado ao extremo, esse routing é [SLM como padrão num pipeline de agentes](/blog/slm-pipeline-de-agentes.html): reservar o modelo de fronteira pra tarefa que exige generalização e usar modelo pequeno — 10 a 30x mais barato — em tudo que é repetitivo.
