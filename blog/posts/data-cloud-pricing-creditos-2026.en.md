...
Data Cloud changed its name and its price list in the same year. It became Data 360 in October 2025 — the same rebranding wave that [renamed Sales Cloud to Agentforce Sales](/blog/en/sales-cloud-vira-agentforce-sales.html); on March 2, 2026, Salesforce overhauled the entire pricing structure — four segmented credit types became one pool, and a fixed profile-based SKU arrived as an alternative to variable consumption. The question budget owners had been asking for two years — how much does Data Cloud really cost — finally has a clearer answer. Only the answer isn't "cheaper." It's "it depends on which of the three models you pick, and picking wrong still blows the budget the same way it used to."
