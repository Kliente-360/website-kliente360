...
1. **Monitor.** Observa el comportamiento del agente en producción de forma continua —no en un informe mensual, sino con suficiente cercanía para detectar la desviación antes de que se acumule.
