...
4. **¿Cuál es el SLA real (no el prometido) en cada etapa?** Tiempo medio que un lead pasa en Calificación hoy. Tiempo medio de aprobación de propuesta. Si nadie lo mide, Salesforce va a exponerlo en el primer mes — generalmente en reunión de board. (Y [el SLA mal calibrado en Service Cloud nace de esa misma brecha entre promesa y capacidad](/blog/es/service-cloud-sla-nao-e-decoracao.html).)
