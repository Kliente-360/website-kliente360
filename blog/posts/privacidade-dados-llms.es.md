...
5. **Pseudo-anonimización o redaction en el camino.** Cuando posible, remover o enmascarar PII antes de enviar al LLM. Librerías como Microsoft Presidio lo hacen. Reduce la superficie de riesgo y simplifica compliance. La misma prueba aplica a otra táctica común de reducción de riesgo: [generar dato sintético no saca el registro del alcance de la LGPD si todavía puede revertirse](/blog/es/dados-sinteticos-acelera-ou-engana.html).
