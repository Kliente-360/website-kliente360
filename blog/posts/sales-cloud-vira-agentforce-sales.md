---
title: "De Sales Cloud a Agentforce Sales: o que a troca sinaliza pra quem já comprou"
slug: "sales-cloud-vira-agentforce-sales"
pillar: "sf"
date: "2026-08-04"
readMinutes: 6
excerpt: "Sales Cloud virou Agentforce Sales no Dreamforce '25 — sem mudar licença, mas sinalizando onde a Salesforce aposta o próximo investimento de produto."
tldr: "Agentforce Sales é o novo nome do Sales Cloud, anunciado no Dreamforce '25 (outubro de 2025) e efetivado no release Spring '26 — sem mudança de licença, instância ou dado para quem já é cliente. A troca acompanha o mesmo movimento que renomeou Service Cloud, Field Service Lightning, Revenue Cloud e Data Cloud, e embute capacidades de agente novas (prospecção, pesquisa de conta, atualização automática de oportunidade) que, em parte, exigem licença adicional de Agentforce. O nome muda de imediato; a pergunta se o investimento em agente compensa continua exigindo a mesma régua de ROI de sempre."
keywords: ["Agentforce Sales", "Sales Cloud rebranding", "Salesforce rename 2026", "Agentforce 360", "Dreamforce 25", "licença Sales Cloud"]
---
...
5. **Data Cloud** virou **Data 360** — [rebranding anterior, de outubro de 2025, que já tratamos quando a reforma de pricing chegou em março](/blog/data-cloud-pricing-creditos-2026.html).
...
2. **Os agentes específicos do pacote costumam exigir licença separada.** Prospecção, qualificação e nutrição de lead via agente entram como add-on, não como parte automática do contrato vigente — [ao contrário do que Salesforce Foundations libera de graça em Enterprise Edition](/blog/salesforce-foundations-o-que-cobre-de-verdade.html), onde uma fatia do Agentforce já vem incluída sem contrato novo.
...
[A régua que decide se Salesforce compensa](/blog/salesforce-roi-matriz.html) continua sendo a mesma de antes do rebranding: ticket médio do cliente, complexidade do processo, maturidade operacional do time e horizonte de retorno aceitável. Agentforce Sales não altera nenhuma dessas quatro variáveis — só adiciona uma linha de decisão nova, específica do agente, sobre o eixo que já existia.

Isso vale até para quem está reavaliando [se Salesforce ainda faz sentido no orçamento atual](/blog/quando-nao-usar-salesforce.html). Um nome novo no catálogo não move o cálculo de ticket baixo versus custo de plataforma — só adiciona mais uma capacidade opcional à lista do que considerar. Empresa que já tinha razão pra questionar o investimento continua tendo a mesma razão, batizada de outro jeito.
