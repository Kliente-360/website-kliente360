...
const STRINGS = {
  pt: {
    ...
    listingLead: 'Textos sobre o que estamos vendo na prática em projetos de Salesforce, Dados e IA.',
    listingMeta: 'Blog Kliente 360 — análise, prática e opinião em Salesforce, Dados e IA. Textos sobre o que estamos vendo na prática.',
    filterAll: 'Todos',
  ...
  en: {
    ...
    listingLead: 'Pieces on what we are seeing in real Salesforce, Data and AI projects.',
    listingMeta: 'Kliente 360 Blog — analysis, practice and opinion on Salesforce, Data and AI. Pieces from real projects.',
    filterAll: 'All',
  ...
  es: {
    ...
    listingLead: 'Textos sobre lo que estamos viendo en proyectos reales de Salesforce, Datos e IA.',
    listingMeta: 'Blog Kliente 360 — análisis, práctica y opinión en Salesforce, Datos e IA. Textos desde proyectos reales.',
    filterAll: 'Todos',
